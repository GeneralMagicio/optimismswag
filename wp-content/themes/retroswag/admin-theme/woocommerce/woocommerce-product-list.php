...
/**
 * Change "view cart" to "Product added. View Cart."
 *
 * @param $params
 * @param $handle
 * @return mixed
 */
function gmswag_view_cart_link( $params, $handle )
{
    switch ($handle) {
        case 'wc-add-to-cart':
            $params['i18n_view_cart'] = "Product added<br>View Cart";
            break;
    }
    return $params;
}
add_filter( 'woocommerce_get_script_data', 'gmswag_view_cart_link', 10, 2 );